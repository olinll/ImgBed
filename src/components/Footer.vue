<template>
    <div class="page-footer" v-if="!disableFooter">
        <p>© 2024-{{ thisYear }} <a class="footer-name" href="https://github.com/olinll/ImgBed" target="_blank">olinll</a>
...
export default {
    ...
    computed: {
        ...
        footerLink() {
            return this.userConfig?.footerLink || 'https://github.com/olinll/ImgBed'
        },
        thisYear() {
